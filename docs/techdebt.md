...
Authority: Accepted deferred recommendations; not implementation authorization
...
<!-- TEMPLATE SETUP: Add an entry only after evidence verifies the problem, the
user accepts the recommendation, and the user intentionally postpones it. Remove
this comment after the register is initialized. Copy and complete this shape:
...
- Accepted recommendation: Remedy the user agrees is worthwhile.
